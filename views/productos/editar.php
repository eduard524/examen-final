...
<?php include '../../config/database.php'; $id=$_GET['id']; $r=$conn->query("SELECT * FROM productos WHERE id=$id")->fetch_assoc(); ?>
<h2>Editar Producto</h2>
<form method='POST' action='actualizar.php'>
<input type='hidden' name='id' value='<?php echo $r['id']; ?>'>
<input name='nombre' value='<?php echo $r['nombre']; ?>' class='form-control mb-2'>
<input name='precio' value='<?php echo $r['precio']; ?>' class='form-control mb-2'>
