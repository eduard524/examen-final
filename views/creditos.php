...
</nav><div class='container mt-4'><h2>Créditos</h2><p>Creado por Armando</p></div><script src='https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js'></script></body></html>